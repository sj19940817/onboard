        ...
        <div className="space-y-16 flex flex-col w-full">
          ...
          <div id="tour1-step1">
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Welcome to the first step in tour 1. Onboard allows you to
          ...
          <div id="tour1-step3">
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Built with Framer Motion and Radix Portal. Onboard enables you
        ...
        <div className="space-y-16 flex flex-col w-full">
          ...
          <div id="tour2-step3">
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Using Onboard&apos;s custom hooks and options gives you full
